...
# -------------------------------
st.set_page_config(
    page_title="AI vs Human Image Detection",
    layout="centered"
)
...
# -------------------------------
@st.cache_resource
def load_ai_vs_human_model():
    """
    Downloads and loads the Keras V3-compatible classifier model
    """
    MODEL_HANDLE = (
        "utkarshsaxenadn/ai-vs-human/"
        "tensorflow2/default/1/ResNet152V2-AIvsHumanGenImages.keras"
    )
...
model = load_ai_vs_human_model()

# -------------------------------
# HOME PAGE
# -------------------------------
if app_mode == "Home":
    st.title("AI vs Human Image Detection")
    st.write(
        "Upload an image to determine whether it was generated by AI or a human."
    )
    st.image("ai-human.jpg", use_container_width=True)
...
# -------------------------------
    ...
    st.subheader("Is this image AI-generated or Human-generated?")
    ...
    if uploaded_file is not None:
        ...
        if st.button("Predict"):
            ...
            if prediction > 0.5:
                ...
                st.success("✅ This image is **Human-generated**")
