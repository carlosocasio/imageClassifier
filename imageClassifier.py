...
# ----------------------------
# Load your small .h5 model
# ----------------------------
MODEL_PATH = "ai_vs_human_small.h5"  # replace with your .h5 model file path
...
app_mode = st.sidebar.selectbox('Select Page', ['Home', 'Upload and Predict'])
...
if app_mode == 'Home':
    ...
    st.image('ai-human.jpg', caption="Example Image", use_column_width=True)
...
# ----------------------------
    ...
    if img_file is not None:
        ...
        if st.button("Predict"):
            ...
            img = image.load_img(img_file, target_size=(224, 224))  # adjust if model input size differs
