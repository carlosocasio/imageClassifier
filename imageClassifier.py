...
# --------------------------------------------------
# Load model (cached so it downloads once)
# --------------------------------------------------
@st.cache_resource
def load_ai_model():
    # IMPORTANT:
    # KaggleHub ONLY accepts MODEL handles — NOT file paths
    model_dir = kagglehub.model_download(
        "utkarshsaxenadn/ai-vs-human/tensorFlow2/default/1"
    )

    # Explicitly point to the .keras file
    model_path = Path(model_dir) / "ResNet152V2-AIvsHumanGenImages.keras"
...
if page == "Home":
    ...
    st.write(
        """
        Upload an image and this app will determine whether it was
        **AI-generated** or **Human-generated** using a deep learning model.
        """
    )
    ...
    if uploaded_file is not None:
        ...
        if st.button("Predict"):
            ...
            if score > 0.5:
                ...
                st.success("👤 Human-Generated Image")
